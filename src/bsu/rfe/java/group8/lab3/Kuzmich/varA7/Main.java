...
import bsu.rfe.java.group8.lab3.Kuzmich.varA7.HornerTableCellRenderer;
import bsu.rfe.java.group8.lab3.Kuzmich.varA7.HornerTableModel;
...
public class Main extends JFrame {
    ...
    private Double[] coefficients={1.0,2.,3.,4.};
    ...
    public Main(Double[] coefficients) {
        ...
        AbstractAction aboutProgrammAction = new AbstractAction("О программе") {
            public void actionPerformed(ActionEvent event) {
                ...
                panel.add(new JLabel("Кузьмич А.К 8-ая группа"));
...
//        getContentPane().add(hboxRange, BorderLayout.NORTH);
        ...
        searchValueMenuItem = new JMenuItem("Найти значение многочлена");
        ...
        searchValueMenuItem.setAction(searchValueAction);
        searchValueMenuItem.setEnabled(true);
